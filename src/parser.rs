...
use nom::{IResult, error::{ParseError, ErrorKind}, Slice, InputIter, InputLength, AsChar, FindToken, CompareResult, Compare};
...
pub fn without_chars_and_line_ending<T, E: ParseError<T>, Q>(chars: Q) -> impl FnMut(T) -> IResult<T, T, E> 
where 
    T: Slice<Range<usize>> + Slice<RangeFrom<usize>> + Slice<RangeTo<usize>>,
    T: InputIter + InputLength,
